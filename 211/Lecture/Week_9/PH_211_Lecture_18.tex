...
\begin{frame}{Conservation of Momentum}
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			\Guides[0]
			\Bullet[0]{-3.5,3.75}{\tiny Credit: xkcd.com};
			\node at (0,2) {\includegraphics[scale=0.4]{LocationMomentumXKCD}};
			\Bullet[0]{-5,0}{\underline{Warm-Up Activity}}
			\Bullet[0]{-5,-0.5}{You throw a brand new bouncy ball against the wall. Is the}
			\Bullet[0]{-5,-1}{speed of the ball right after hitting the wall greater than,}
			\Bullet[0]{-5,-1.5}{less than, or equal to the speed of the ball right before}
			\Bullet[0]{-5,-2}{hitting the wall?}
			\Bullet[0]{-5,-2.5}{A. Greater than}
			\Bullet[0]{-5,-3}{B. Less than}
			\Bullet[0]{-5,-3.5}{C. Equal to}
		\end{tikzpicture}
	\end{figure}
\end{frame}
